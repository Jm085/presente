const motivos = [
  ...
  "A cada dia, você me surpreende de novas maneiras.",
  ...
  "A maneira como me olha me faz sentir especial.",
  "Você sempre está ao meu lado, não importa a situação.",
  "A forma como cuida de mim é incomparável.",
